...
## Installation
  ...
  ## Theoretical speed-up rate
   ...
   If $C_l \lt C_t$:  
   &ensp;&ensp; $T_M=C_l+C_t*n$ &ensp;&ensp;&ensp;&ensp;&ensp;&ensp; $n$ is the training steps for each epoch  
   &ensp;&ensp; $T_C=(C_l+C_t)*n$  
   &ensp;&ensp; Theoretical speed-up rate $S_{rate} = \frac{(C_l+C_t)n}{C_l+nC_t}$
